  ...
  return (
    <div className="min-h-screen bg-dp-bg flex items-center justify-center px-4">
      <div className="bg-dp-surface rounded-2xl border border-dp-border w-full max-w-md p-8 shadow-[0_0_40px_rgba(109,40,217,0.15)]">
        ...
        {step === 'form' ? (
          <>
            <h1 className="text-2xl font-bold text-violet-50 mb-1">Welcome back</h1>
            <p className="text-violet-400 text-sm mb-8">Sign in to your account to continue</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2.5 bg-dp-bg border border-dp-bstrong rounded-lg text-sm text-violet-100 placeholder:text-violet-600 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-shadow"
          ...
          <>
            ...
            <h1 className="text-2xl font-bold text-violet-50 mb-1">Check your email</h1>
